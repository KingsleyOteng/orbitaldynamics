...
private:
    ...
    double m_rl, m_rdotl, m_rvdotl,m_betal,  m_sinu, m_cosu, m_su, m_sin2u, m_cos2u, m_temp1, m_temp2, m_cosisq, m_satrec_con41, m_satrec_x1mth2, m_satrec_x7thm1, m_rvdot, m_sinsu, m_cossu, m_snod;
