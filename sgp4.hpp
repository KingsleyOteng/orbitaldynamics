...
private:
    ...
    m_nm, m_satrec_no, m_em, m_satrec_ecco, m_inclm, m_satrec_inclo, m_ecose, m_axnl, m_ecose, m_coseo1, m_aynl, m, m_ecose,m_axnl,m_coseo1,m_sineo1,m_esine,m_el2,m_pl ,m_am ,m_el2;
