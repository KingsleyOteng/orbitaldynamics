...
private:
    ...
    double m_twopi, m_pi, m_zns, m_zm, m_zmos, m_t, m_zes, m_znl, m_zel, m_zf, m_sinzf, m_f2, m_f3, m_ses, m_sis, m_sls, m_sghs, m_shs, m_se2, m_si2, m_se3, m_si3, f3, m_sl2, m_sgh2, m_sh2, m_zmol, m_sl3, m_sgh3, m_sgh4, m_sl4, m_sh3, m_e3, m_ee2, m_sil, m_xi2, m_sel, m_xi3, m_sli, m_sghl, m_shll, m_sll, m_xl4, m_xl2, m_xl3, m_xgh2, m_xgh3, m_xgh4,
    m_xh2, m_xh3, m_pe, m_pinc, m_pl, m_pgh, m_ph, m_peo, m_pinco, m_plo, m_pgho, m_ep, m_pho, m_inclp, m_sinip, m_cosip, m_argpp, m_nodep, m_mp, m_sinop, m_cosop, m_alfdp, m_betdp, m_dalf, m_dbet, m_opsmode, m_xls, m_dls, m_xnoh;
